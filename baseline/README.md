...
This baseline runs the local Qwen2.5-1.5B-Instruct text model directly on
...
## Legacy multimodal image VQA evaluation (not used by Qwen2.5-1.5B)

This separate legacy evaluator requires `Qwen2.5-VL-3B-Instruct` weights and tests them
